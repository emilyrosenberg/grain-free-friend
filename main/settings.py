...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            # Lets django know to get this custom styling
...
# Thanks to John from CI tutoring for help understanding the two DB's
...
# Fix for static files not loading in deployed app: https://stackoverflow.com/questions/28961177/heroku-static-files-not-loading-django
